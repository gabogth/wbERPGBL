<%@ Page Title="" Language="C#" MasterPageFile="~/ASP/master.Master" AutoEventWireup="true" CodeBehind="cambiar_contrasena_enforce.aspx.cs" Inherits="wbERPGBL.ASP.cambiar_contrasena_enforce" %>
<%@ Import Namespace="Modelo" %>
<asp:Content ID="Content1" ContentPlaceHolderID="IDScripts" runat="server">
    <script src="../js/Controllers/jsEnforcePw.js"></script>
</asp:Content>
            ...
            <section class="container">
                ...
                <div class="row">
                    <form id="frmInsertar" action="#">
                        <h3 class="block-title"><i>No podrá continuar mientras no cambie de contraseña.</i></h3>
