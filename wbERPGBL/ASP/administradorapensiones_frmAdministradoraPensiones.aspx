<%@ Page Title="" Language="C#" MasterPageFile="~/ASP/master.Master" AutoEventWireup="true" CodeBehind="administradorapensiones_frmAdministradoraPensiones.aspx.cs" Inherits="wbERPGBL.ASP.administradorapensiones_frmAdministradoraPensiones" %>
<asp:Content ID="Content1" ContentPlaceHolderID="IDScripts" runat="server">
    <script src="../js/Controllers/jsAdministradoraPensiones.js"></script>
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="IDCuerpo" runat="server">
    <div class="tile">
        <h2 class="tile-title">Mantenimiento de Administradoras de pensiones</h2>
                        ...
                        <div class="list-container">
                            <div class="row">
                                <div class="col-lg-6 col-md-12">
                                    <div class="block-area">
                                        <label for="txtAdministradora">ADMINISTRADORA: </label>
                                        <input type="text" class="form-control m-b-10" id="txtAdministradora" name="txtAdministradora" required="required" placeholder="Ingrese Administradoras...">
                                    </div>
                                </div>
                                <div class="col-lg-6 col-md-12">
                                    <div class="block-area">
                            ...
                            <div class="row">
                                <div class="col-lg-6 col-md-12">
                                    <div class="block-area">
                                        ...
                                        <select id="cbSistema" name="cbSistema" style="width: 100%;">
                                        </select>
                                    </div>
                                </div>
                            </div>
