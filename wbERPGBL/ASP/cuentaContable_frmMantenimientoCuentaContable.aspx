<%@ Page Title="" Language="C#" MasterPageFile="~/ASP/master.Master" AutoEventWireup="true" CodeBehind="cuentaContable_frmMantenimientoCuentaContable.aspx.cs" Inherits="wbERPGBL.ASP.cuentaContable_frmMantenimientoCuentaContable" %>
<asp:Content ID="Content1" ContentPlaceHolderID="IDScripts" runat="server">
    <script src="../js/Controllers/jsCuentaContable.js"></script>
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="IDCuerpo" runat="server">
    <div class="tile">
        <h2 class="tile-title">Mantenimiento de cuentas contables</h2>
                    ...
                    <form id="frmInsertar" action="#">
                        <div class="list-container">
                            <div class="row">
                                <div class="col-lg-6">
                                    <div class="block-area">
                                        <label for="txtNombreCuenta">Nombre de la cuenta: </label>
                                        <input type="text" class="form-control m-b-10" id="txtNombreCuenta" name="txtNombreCuenta" placeholder="Ingrese el nombre de la cuenta..." />
                                    </div>
                                </div>
                                <div class="col-lg-6">
                                    <div class="block-area">
                                        <label for="txtCuenta">Cuenta: </label>
                                        <input type="text" class="form-control m-b-10" id="txtCuenta" name="txtCuenta" placeholder="Ejemplo: 10.1.12.2" />
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-lg-6">
                                    <div class="block-area">
                                        <label for="cbTipoCuenta">Tipo de cuenta: </label>
                                        <select id="cbTipoCuenta" name="cbTipoCuenta" style="width: 100%;">
                                        </select>
                                    </div>
                                </div>
                            </div>
