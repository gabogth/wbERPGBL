<%@ Page Title="" Language="C#" MasterPageFile="~/ASP/master.Master" AutoEventWireup="true" CodeBehind="facturas_frmMantenimientoFacturasaspx.aspx.cs" Inherits="wbERPGBL.ASP.facturas_frmMantenimientoFacturasaspx" %>
<asp:Content ID="Content1" ContentPlaceHolderID="IDScripts" runat="server">
    <script src="../js/Controllers/jsMantenimientoFactura.js"></script>
</asp:Content>
