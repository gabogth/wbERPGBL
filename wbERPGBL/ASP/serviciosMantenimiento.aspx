<%@ Page Title="" Language="C#" MasterPageFile="~/ASP/master.Master" AutoEventWireup="true" CodeBehind="serviciosMantenimiento.aspx.cs" Inherits="wbERPGBL.ASP.serviciosMantenimiento" %>
<asp:Content ID="Content1" ContentPlaceHolderID="IDScripts" runat="server">
    <script src="../js/Controllers/jsServicio.js"></script>
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="IDCuerpo" runat="server">
    <div class="tile">
        <h2 class="tile-title">Mantenimiento de Servicios</h2>
                                ...
                                <table class="table table-bordered table-hover">
                                    <thead>
                                        <tr>
                                            ...
                                            <th class="text-center">Tipo Intangible</th>
                                            <th class="text-center"></th>
                                            <th class="text-center"></th>
                                            <th class="text-center"></th>
                                        </tr>
                            ...
                            <div class="row">
                                <div class="col-lg-6">
                                    <div class="block-area">
                                        ...
                                        <input type="text" class="form-control m-b-10" id="txtServicio" name="txtServicio" placeholder="Ingrese el servicio..." />
                                    </div>
                                </div>
                                <div class="col-lg-6">
                                    <div class="block-area">
                                        <label for="cbTipoIntangible">Tipo Intangible: </label>
                                        <select id="cbTipoIntangible" name="cbTipoIntangible" data-placeholder="Tipo intangible" data-allow-clear="true" style="width: 100%;" required="required"></select>
                                    </div>
                                </div>
                            </div>
                            <div class="row">
