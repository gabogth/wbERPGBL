<%@ Page Title="" Language="C#" MasterPageFile="~/ASP/master.Master" AutoEventWireup="true" CodeBehind="tipodocumentoidentidad_frmMantenimientoTipoDocumentoIdentidad.aspx.cs" Inherits="wbERPGBL.ASP.tipodocumentoidentidad_frmMantenimientoTipoDocumentoIdentidad" %>
<asp:Content ID="Content1" ContentPlaceHolderID="IDScripts" runat="server">
    <script src="../js/Controllers/jsTipoDocumentoIdentidad.js"></script>
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="IDCuerpo" runat="server">
    <div class="tile">
        <h2 class="tile-title">Mantenimiento de Tipos de documento</h2>
                                ...
                                <table class="table table-bordered table-hover">
                                    <thead>
                                        <tr>
                                            ...
                                            <th class="text-center">TIPO DOCUMENTO IDENTIDAD</th>
                        ...
                        <div class="list-container">
                            <div class="row">
                                <div class="col-lg-6 col-md-12">
                                    <div class="block-area">
                                        <label for="txtTipoDocumento">Tipo de Documento de Identidad: </label>
                                        <input type="text" class="form-control m-b-10" id="txtTipoDocumento" name="txtTipoDocumento" required="required" placeholder="Ingrese el tipo de documento">
                                    </div>
                                </div>
                                <div class="col-lg-6 col-md-12">
                                    <div class="block-area">
                            ...
                            <div class="row">
                                <div class="col-lg-6 col-md-12">
                                    <div class="block-area">
                                        ...
                                        <input type="text" class="form-control m-b-10" id="txtAbreviacion" name="txtAbreviacion" required="required" placeholder="Ingrese la abreviación">
                                    </div>
                                </div>
                                <div class="col-lg-6 col-md-12">
                                    <div class="block-area">
