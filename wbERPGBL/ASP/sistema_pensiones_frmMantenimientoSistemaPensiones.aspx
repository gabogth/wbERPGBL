<%@ Page Title="" Language="C#" MasterPageFile="~/ASP/master.Master" AutoEventWireup="true" CodeBehind="sistema_pensiones_frmMantenimientoSistemaPensiones.aspx.cs" Inherits="wbERPGBL.ASP.sistema_pensiones_frmMantenimientoSistemaPensiones" %>
<asp:Content ID="Content1" ContentPlaceHolderID="IDScripts" runat="server">
    <script src="../js/Controllers/jsSistemaPensiones.js"></script>
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="IDCuerpo" runat="server">
    <div class="tile">
        <h2 class="tile-title">Mantenimiento de los sistemas pensionarios</h2>
                                ...
                                <table class="table table-bordered table-hover tile-title">
                                    <thead>
                                        <tr>
                                            ...
                                            <th class="text-center">SISTEMA PENSIONARIO</th>
                    ...
                    <form id="frmInsertar" action="#">
                        <div class="list-container">
                            <div class="col-lg-6 col-md-12">
                                <div class="block-area">
                                    <label for="txtSistema">Sistema de pensión: </label>
                                    <input type="text" class="form-control m-b-10" id="txtSistema" name="txtSistema" required="required" placeholder="Ingrese Sistema de pensión">
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-lg-6 col-md-12">
