<%@ Page Title="" Language="C#" MasterPageFile="~/ASP/master.Master" AutoEventWireup="true" CodeBehind="essalud_frmMantenimientoEssalud.aspx.cs" Inherits="wbERPGBL.ASP.essalud_frmMantenimientoEssalud" %>
<asp:Content ID="Content1" ContentPlaceHolderID="IDScripts" runat="server">
    <script src="../js/Controllers/jsEssalud.js"></script>
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="IDCuerpo" runat="server">
    <div class="tile">
        <h2 class="tile-title">Mantenimiento del seguro de salud</h2>
                    ...
                    <form id="frmInsertar" action="#">
                        <div class="list-container">
                            <div class="row">
                                <div class="col-lg-6">
                                    <div class="block-area">
                                        ...
                                        <input type="text" class="form-control m-b-10" id="txtSeguro" name="txtSeguro" placeholder="Ingrese el seguro..." />
                                    </div>
                                </div>
                                <div class="col-lg-6">
                                    <div class="block-area">
                            ...
                            <div class="row">
                                <div class="col-lg-6">
                                    <div class="block-area">
                                        <label for="txtFechaInicio">Rige desde: </label>
                                        <input type="date" class="form-control m-b-10" id="txtFechaInicio" name="txtFechaInicio" />
                                    </div>
                                </div>
                            </div>
                        </div>
