<%@ Page Title="" Language="C#" MasterPageFile="~/ASP/master.Master" AutoEventWireup="true" CodeBehind="asientoPagos.aspx.cs" Inherits="wbERPGBL.ASP.asientoPagos" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="IDScripts" runat="server">
    <script src="../js/Controllers/jsAsientoPagos.js?v=1.2"></script>
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="IDCuerpo" runat="server">
    ...
    %>
    <div class="tile">
        <h2 class="tile-title">ASIENTO CONTABLE PAGOS DE <%= itemVentas.EMPRESA_ALIAS + ":" + itemVentas.SERIE_SERIE + "-" + itemVentas.correlativo %></h2>
        ...
        <div class="p-10">
            <section class="container">
                ...
                <div class="row block-area">
                    ...
                    <input type="hidden" value="<%= itemVentas.MONEDA_LOCAL %>" id="txtLOCAL" />
                    <input type="hidden" value="<%= itemVentas.idempresa %>" id="txtIDEmpresa" />
                    <input type="hidden" value="<%= itemVentas.SERIE_SERIE + "-" + itemVentas.correlativo %>" id="txtDocumento" />
                    <input type="hidden" value="<%= itemVentas.CLIENTE_RAZON_SOCIAL %>" id="txtClienteDoc" />
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="block-area" id="responsiveTable">
                            <h3 class="block-title">ASIENTOS: <a href="#" id="btnInsertar"><span class="fa fa-plus fa-1x"></span>NUEVO ASIENTO MANUAL</a></h3>
                            <div class="table-responsive overflow">
                                <table class="table table-bordered table-hover">
                                    ...
                                    <tfoot id="tbl_footer">
                                        <tr>
                                            <td colspan="7" class="text-right"><i>TOTALES</i></td>
                ...
                <div class="modal-body">
                    <form id="frmInsertar" action="#">
                        <div class="list-container">
                            <div class="row" id="dvFechaPago" style="display: none;">
                                <div class="col-lg-6 col-md-12 push-lg-3">
                                    <div class="block-area">
                                        <label for="dtpFechaPago">Fecha pago: </label>
                                        <input type="date" class="form-control m-b-10" id="dtpFechaPago" name="dtpFechaPago">
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                            ...
                            <div class="row">
                                <div class="col-lg-6 col-md-12">
                                    <div class="block-area">
                                        <label for="txtMontoDebe:number">Monto: </label>
                                ...
                                <div class="col-lg-6 col-md-12">
                                    <div class="block-area">
                                        <label for="txtMontoHaber:number">Monto: </label>
