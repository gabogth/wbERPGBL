<%@ Page Title="" Language="C#" MasterPageFile="~/ASP/master.Master" AutoEventWireup="true" CodeBehind="tipocomprobante_frmMantenimientoTipoComprobante.aspx.cs" Inherits="wbERPGBL.ASP.tipocomprobante_frmMantenimientoTipoComprobante" %>
<asp:Content ID="Content1" ContentPlaceHolderID="IDScripts" runat="server">
    <script src="../js/Controllers/jsTipoComprobante.js"></script>
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="IDCuerpo" runat="server">
    <div class="tile">
        <h2 class="tile-title">Mantenimiento de Tipos de Comprobantes</h2>
                            ...
                            <div class="row">
                                <div class="col-lg-6 col-md-12">
                                    <div class="block-area">
                                        ...
                                        <input type="text" class="form-control m-b-10" id="txtTipoComprobante" name="txtTipoComprobante" required="required" placeholder="Ingrese Tipo de Comprobante">
                                    </div>
                                </div>
                                <div class="col-lg-6 col-md-12">
                                    <div class="block-area">
                                        <label for="txtCodigo">Codigo: </label>
                                        <input type="text" class="form-control m-b-10" id="txtCodigo" name="txtCodigo" required="required" placeholder="Ingrese Codigo">
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-lg-6 col-md-12">
                                    <div class="block-area">
                                        ...
                                        <input type="text" class="form-control m-b-10" id="txtFactor" name="txtFactor" required="required" data-a-sep="" data-a-dec="." placeholder="Ingrese Factor de impuesto">
                                    </div>
                                </div>
                                <div class="col-lg-6 col-md-12">
                                    <div class="block-area">
                                        <label for="txtPorcentaje">Porcentaje: </label>
                                        <input type="text" class="form-control m-b-10" id="txtPorcentaje" name="txtPorcentaje" data-a-sep="" data-a-dec="." data-a-sign="%" data-p-sign="s" required="required" placeholder="Ingrese Porcentaje">
                                    </div>
                                </div>
                            </div>
                        </div>
