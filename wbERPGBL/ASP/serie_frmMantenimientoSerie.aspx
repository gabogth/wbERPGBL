<%@ Page Title="" Language="C#" MasterPageFile="~/ASP/master.Master" AutoEventWireup="true" CodeBehind="serie_frmMantenimientoSerie.aspx.cs" Inherits="wbERPGBL.ASP.serie_frmMantenimientoSerie" %>
<asp:Content ID="Content1" ContentPlaceHolderID="IDScripts" runat="server">
    <script src="../js/Controllers/jsSerie.js"></script>
</asp:Content>
                            ...
                            <div class="row">
                                <div class="col-lg-6 col-md-12">
                                    <div class="block-area">
                                        ...
                                        <input type="text" maxlength="4" class="form-control m-b-10" id="txtSerie" name="txtSerie" required="required" placeholder="Ingrese Serie">
                                    </div>
                                </div>
                                <div class="col-lg-6 col-md-12">
                                    <div class="block-area">
                                        <label for="txtDescripcion">Descripción: </label>
                                        <input type="text" class="form-control m-b-10" id="txtDescripcion" name="txtDescripcion" required="required" placeholder="Ingrese Descripción">
                                    </div>
                                </div>
                            </div>
                        </div>
