<%@ Page Title="" Language="C#" MasterPageFile="~/ASP/master.Master" AutoEventWireup="true" CodeBehind="remuneracionMinimaVital_frmMantenimientoRemuneracionMinimaVital.aspx.cs" Inherits="wbERPGBL.ASP.remuneracionMinimaVital_frmMantenimientoRemuneracionMinimaVital" %>
<asp:Content ID="Content1" ContentPlaceHolderID="IDScripts" runat="server">
    <script src="../js/Controllers/jsRemuneracionMinimaVital.js"></script>
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="IDCuerpo" runat="server">
    <div class="tile">
        <h2 class="tile-title">Mantenimiento de Serie</h2>
                    ...
                    <form id="frmInsertar" action="#">
                        <div class="list-container">
                            <div class="col-lg-6 col-md-12">
                                <div class="block-area">
                                    <label for="dtpInicio">Rige Desde: </label>
                            ...
                            <div class="row">
                                <div class="col-lg-6 col-md-12">
                                    <div class="block-area">
                                        ...
                                        <input type="text" data-a-sep="" data-a-dec="." class="form-control m-b-10" id="txtMonto" name="txtMonto" required="required" placeholder="Ingrese Monto">
                                    </div>
                                </div>
                            </div>
                        </div>
