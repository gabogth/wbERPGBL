<%@ Page Title="" Language="C#" MasterPageFile="~/ASP/master.Master" AutoEventWireup="true" CodeBehind="tipoPago_frmMantenimientoTipoPago.aspx.cs" Inherits="wbERPGBL.ASP.tipoPago_frmMantenimientoTipoPago" %>
<asp:Content ID="Content1" ContentPlaceHolderID="IDScripts" runat="server">
    <script src="../js/Controllers/jsTipoPago.js"></script>
</asp:Content>
                            ...
                            <div class="row">
                                <div class="col-lg-6 col-md-12">
                                    <div class="block-area">
                                        ...
                                        <input type="text" class="form-control m-b-10" id="txtTipoPago" name="txtTipoPago" required="required" placeholder="Ingrese tipo pago">
                                    </div>
                                </div>
                                <div class="col-lg-6 col-md-12">
                                    <div class="block-area">
