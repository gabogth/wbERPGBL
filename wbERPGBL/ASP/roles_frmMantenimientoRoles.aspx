<%@ Page Title="" Language="C#" MasterPageFile="~/ASP/master.Master" AutoEventWireup="true" CodeBehind="roles_frmMantenimientoRoles.aspx.cs" Inherits="wbERPGBL.ASP.roles_frmMantenimientoRoles" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="IDScripts" runat="server">
    ...
    <script src="../js/Controllers/jsRoles.js"></script>
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="IDCuerpo" runat="server">
    <div class="tile">
        <h2 class="tile-title">Mantenimiento de roles</h2>
                            ...
                            <div class="row">
                                <div class="col-lg-6 col-md-12">
                                    <div class="block-area">
                                        ...
                                        <input type="text" class="form-control m-b-10" id="txtRol" required="required" name="txtRol" placeholder="Ingrese Rol">
                                    </div>
                                </div>
                                <div class="col-lg-6 col-md-12">
                                    <div class="block-area">
                                        <label for="txtFecha">Puede ver desde: </label>
                                        <input type="date" id="txtFecha" name="txtFecha" class="form-control input-sm" required="required" />
                                    </div>
                                </div>
                            </div>
                            <div class="row">
