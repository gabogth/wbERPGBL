<%@ Page Title="" Language="C#" MasterPageFile="~/ASP/master.Master" AutoEventWireup="true" CodeBehind="asignacionFamiliar_frmMantenimientoAsignacionFamiliar.aspx.cs" Inherits="wbERPGBL.ASP.asignacionFamiliar_frmMantenimientoAsignacionFamiliar" %>
<asp:Content ID="Content1" ContentPlaceHolderID="IDScripts" runat="server">
    <script src="../js/Controllers/jsAsignacionFamiliar.js"></script>
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="IDCuerpo" runat="server">
    <div class="tile">
        <h2 class="tile-title">Mantenimiento de la asignación familiar</h2>
                    ...
                    <form id="frmInsertar" action="#">
                        <div class="list-container">
                            <div class="row">
                                <div class="col-lg-6">
                                    <div class="block-area">
                                        <label for="cbTipo">Tipo de asignación: </label>
                                        <select id="cbTipo" name="cbTipo" class="form-control" style="width:100%;" required="required">
                                            <option value="0">Fijo</option>
                                            <option value="1">Porcentual</option>
                                        </select>
                                    </div>
                                </div>
                                <div class="col-lg-6" id="dvFijo">
                                    <div class="block-area">
                                        <label for="txtFijo">Fijo (S/.): </label>
                                        <input type="text" data-a-sep="" data-a-dec="." class="form-control m-b-10" id="txtFijo" name="txtFijo" placeholder="Ingrese el monto fijo..." />
                                    </div>
                                </div>
                                <div class="col-lg-6" id="dvPorcentaje" style="display: none;">
                                    <div class="block-area">
                                        <label for="txtPorcentaje">Porcentaje (%): </label>
                                        <input type="text" data-a-sep="" data-p-sign="s" data-a-dec="." class="form-control m-b-10" id="txtPorcentaje" name="txtPorcentaje" placeholder="Ingrese el porcentaje..." />
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-lg-12">
                                    <div class="block-area">
                                        ...
                                        <textarea class="form-control m-b-10" id="txtDetalle" name="txtDetalle" required="required" placeholder="Ingrese el detalle..."></textarea>
                                    </div>
                                </div>
                            </div>
                        </div>
