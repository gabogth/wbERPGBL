<%@ Page Title="" Language="C#" MasterPageFile="~/ASP/master.Master" AutoEventWireup="true" CodeBehind="tipoCuenta_frmMantenimientoTipoCuenta.aspx.cs" Inherits="wbERPGBL.ASP.tipoCuenta_frmMantenimientoTipoCuenta" %>
<asp:Content ID="Content1" ContentPlaceHolderID="IDScripts" runat="server">
    <script src="../js/Controllers/jsTipoCuenta.js"></script>
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="IDCuerpo" runat="server">
    <div class="tile">
        <h2 class="tile-title">Mantenimiento de tipos de cuenta</h2>
                            ...
                            <div class="row">
                                <div class="col-lg-6">
                                    <div class="block-area">
                                        ...
                                        <input type="text" class="form-control m-b-10" id="txtTipoCuenta" name="txtTipoCuenta" placeholder="Ingrese el tipo de cuenta..." />
                                    </div>
                                </div>
                                <div class="col-lg-6">
                                    <div class="block-area">
                                        <label for="txtDescripcion">Descripción: </label>
                                        <textarea class="form-control m-b-10" id="txtDescripcion" name="txtDescripcion" placeholder="Ingrese una descripción..." ></textarea>
                                    </div>
                                </div>
                            </div>
                        </div>
