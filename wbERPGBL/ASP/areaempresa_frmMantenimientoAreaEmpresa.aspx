<%@ Page Title="" Language="C#" MasterPageFile="~/ASP/master.Master" AutoEventWireup="true" CodeBehind="areaempresa_frmMantenimientoAreaEmpresa.aspx.cs" Inherits="wbERPGBL.ASP.areaempresa_frmMantenimientoAreaEmpresa" %>
<asp:Content ID="Content1" ContentPlaceHolderID="IDScripts" runat="server">
    <script src="../js/Controllers/jsAreaEmpresa.js"></script>
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="IDCuerpo" runat="server">
    <div class="tile">
        <h2 class="tile-title">Mantenimiento de las areas de la empresa</h2>
                            ...
                            <div class="row">
                                <div class="col-lg-12">
                                    <div class="block-area">
                                        ...
                                        <input type="text" class="form-control m-b-10" id="txtArea" name="txtArea" required="required" placeholder="Ingrese el area...">
                                    </div>
                                </div>
                            </div>
                        </div>
