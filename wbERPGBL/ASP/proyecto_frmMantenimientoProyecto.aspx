<%@ Page Title="" Language="C#" MasterPageFile="~/ASP/master.Master" AutoEventWireup="true" CodeBehind="proyecto_frmMantenimientoProyecto.aspx.cs" Inherits="wbERPGBL.ASP.proyecto_frmMantenimientoProyecto" %>
<asp:Content ID="Content1" ContentPlaceHolderID="IDScripts" runat="server">
    <script src="../js/Controllers/jsProyecto.js"></script>
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="IDCuerpo" runat="server">
    <div class="tile">
        <h2 class="tile-title">Mantenimiento de Proyectos</h2>
                    ...
                    <div class="col-lg-12">
                        <div class="block-area" id="responsiveTable">
                            ...
                            <div class="table-responsive overflow">
                                <table class="table-tile table table-bordered table-hover">
                                    <thead>
                                        <tr>
                            ...
                            <div class="row">
                                <div class="col-lg-6 col-md-12">
                                    <div class="block-area">
                                        ...
                                        <input type="text" class="form-control m-b-10" id="txtProyecto" name="txtProyecto" required="required" placeholder="Ingrese el proyecto">
                                    </div>
                                </div>
                                <div class="col-lg-6 col-md-12">
                                    <div class="block-area">
                                        <label for="cbEmpresa">Empresa: </label>
                                        <select id="cbEmpresa" name="cbEmpresa" style="width: 100%;">
                                        </select>
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                ...
                                <div class="col-lg-6 col-md-12">
                                    <div class="block-area">
                                        ...
                                        <input type="date" class="form-control m-b-10" id="dtpFin" name="dtpFin" required="required">
                                    </div>
                                </div>
                            </div>
                        </div>
