<%@ Page Title="" Language="C#" MasterPageFile="~/ASP/master.Master" AutoEventWireup="true" CodeBehind="sede_frmMantenimientoSede.aspx.cs" Inherits="wbERPGBL.ASP.sede_frmMantenimientoSede" %>
<asp:Content ID="Content1" ContentPlaceHolderID="IDScripts" runat="server">
    <script src="../js/Controllers/jsSede.js"></script>
</asp:Content>
                        ...
                        <div class="list-container">
                            <div class="col-lg-6 col-md-12">
                                <div class="block-area">
                                    ...
                                    <input type="text" maxlength="4" class="form-control m-b-10" id="txtSede" name="txtSede" required="required" placeholder="Ingrese la sede">
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-lg-6 col-md-12">
