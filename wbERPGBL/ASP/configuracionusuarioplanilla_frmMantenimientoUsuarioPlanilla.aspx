<%@ Page Title="" Language="C#" MasterPageFile="~/ASP/master.Master" AutoEventWireup="true" CodeBehind="configuracionusuarioplanilla_frmMantenimientoUsuarioPlanilla.aspx.cs" Inherits="wbERPGBL.ASP.configuracionusuarioplanilla_frmMantenimientoUsuarioPlanilla" %>
<asp:Content ID="Content1" ContentPlaceHolderID="IDScripts" runat="server">
    <script src="../js/Controllers/jsConfiguracionUsuarioPlanilla.js"></script>
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="IDCuerpo" runat="server">
    <div class="tile">
        <h2 class="tile-title">Mantenimiento de la configuración del usuario planilla</h2>
                    ...
                    <form id="frmInsertar" action="#">
                        <div class="list-container">
                            <div class="row">
                                ...
                                <div class="col-lg-6 col-md-12">
                                    <div class="block-area">
                                        <label for="cbConfiguracion">Configuración pensionaria: </label>
                                        <select id="cbConfiguracion" name="cbConfiguracion" style="width: 100%;" required="required">
                                        </select>
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-lg-6 col-md-12">
                                    <div class="block-area">
                                        <label for="cbTipo">Tipo de comisión: </label>
                                        <select id="cbTipo" class="form-control m-b-10" name="cbTipo" required="required">
                                ...
                                <div class="col-lg-6 col-md-12">
                                    <div class="block-area">
                                        <label for="ckCargaFamiliar">Asignación Familiar:</label><br />
                                        <label for="ckCargaFamiliar">Carga familiar: 
                                            <input type="checkbox" id="ckCargaFamiliar" name="ckCargaFamiliar">
                                        </label>
                                    </div>
                                </div>
                            </div>
                            <div class="row" id="dvHijos">
                                <div class="col-lg-6 col-md-12">
                                    <div class="block-area">
                                        <label for="txtHijos"># Hijos: </label>
                                        <input type="number" min="1" class="form-control m-b-10" id="txtHijos" name="txtHijos" required="required">
                                    </div>
                                </div>
                            </div>
                        </div>
