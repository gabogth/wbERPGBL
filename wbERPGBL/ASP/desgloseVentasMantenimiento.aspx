<%@ Page Title="" Language="C#" MasterPageFile="~/ASP/master.Master" AutoEventWireup="true" CodeBehind="desgloseVentasMantenimiento.aspx.cs" Inherits="wbERPGBL.ASP.desgloseVentasMantenimiento" %>
<asp:Content ID="Content1" ContentPlaceHolderID="IDScripts" runat="server">
    <script src="../js/Controllers/jsDesgloseVentas.js"></script>
</asp:Content>
