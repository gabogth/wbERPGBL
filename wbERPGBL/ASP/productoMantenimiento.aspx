<%@ Page Title="" Language="C#" MasterPageFile="~/ASP/master.Master" AutoEventWireup="true" CodeBehind="productoMantenimiento.aspx.cs" Inherits="wbERPGBL.ASP.productoMantenimiento" %>
<asp:Content ID="Content1" ContentPlaceHolderID="IDScripts" runat="server">
    <script src="../js/Controllers/jsProducto.js"></script>
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="IDCuerpo" runat="server">
    <div class="tile">
        <h2 class="tile-title">Mantenimiento de Productos</h2>
                                ...
                                <table class="table table-bordered table-hover">
                                    <thead>
                                        <tr>
                                            ...
                                            <th class="text-center">Tipo Existencia</th>
                                            <th class="text-center"></th>
                                            <th class="text-center"></th>
                                            <th class="text-center"></th>
                                        </tr>
                            ...
                            <div class="row">
                                <div class="col-lg-6">
                                    <div class="block-area">
                                        ...
                                        <input type="text" class="form-control m-b-10" id="txtProducto" name="txtProducto" placeholder="Ingrese el producto..." />
                                    </div>
                                </div>
                                <div class="col-lg-6">
                                    <div class="block-area">
                                        <label for="cbTipoExistencia">Tipo Existencia: </label>
                                        <select id="cbTipoExistencia" name="cbTipoExistencia" data-placeholder="Tipo de existencia" data-allow-clear="true" style="width: 100%;" required="required"></select>
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-sm-12">
                                    <div class="block-area">
                                        ...
                                        <textarea class="form-control m-b-10" id="txtCaracteristicas" name="txtCaracteristicas" placeholder="Ingrese las características..." ></textarea>
                                    </div>
                                </div>
                            </div>
                        </div>
