<%@ Page Title="" Language="C#" MasterPageFile="~/ASP/master.Master" AutoEventWireup="true" CodeBehind="sueldos_frmMantenimientoSueldos.aspx.cs" Inherits="wbERPGBL.ASP.sueldos_frmMantenimientoSueldos" %>
<asp:Content ID="Content1" ContentPlaceHolderID="IDScripts" runat="server">
    <script src="../js/Controllers/jsSueldos.js"></script>
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="IDCuerpo" runat="server">
    <div class="tile">
        <h2 class="tile-title">Mantenimiento de Sueldos</h2>
                        ...
                        <div class="list-container">
                            ...
                            <div class="col-lg-6 col-md-12">
                                <div class="block-area">
                                    ...
                                    <input type="text" data-a-sep="" data-a-dec="." class="form-control m-b-10" id="txtSueldo" name="txtSueldo" required="required" placeholder="Ingrese Sueldo">
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-lg-6 col-md-12">
                                    <div class="block-area">
                                        ...
                                        <input type="text" class="form-control m-b-10" id="txtMotivo" name="txtMotivo" required="required" placeholder="Ingrese Motivo...">
                                    </div>
                                </div>
                            </div>
                        </div>
