<%@ Page Title="" Language="C#" MasterPageFile="~/ASP/master.Master" AutoEventWireup="true" CodeBehind="moneda_frmMantenimientoMoneda.aspx.cs" Inherits="wbERPGBL.ASP.moneda_frmMantenimientoMoneda" %>
<asp:Content ID="Content1" ContentPlaceHolderID="IDScripts" runat="server">
    <script src="../js/Controllers/jsMoneda.js"></script>
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="IDCuerpo" runat="server">
    <div class="tile">
        <h2 class="tile-title">Mantenimiento de Monedas</h2>
                            ...
                            <div class="row">
                                <div class="col-lg-6 col-md-12">
                                    <div class="block-area">
                                        ...
                                        <input type="text" class="form-control m-b-10" id="txtMoneda" name="txtMoneda" required="required" placeholder="Ingrese Moneda">
                                    </div>
                                </div>
                                <div class="col-lg-6 col-md-12">
                                    <div class="block-area">
                                        <label for="txtSimbolo">Simbolo: </label>
                                        <input type="text" class="form-control m-b-10" id="txtSimbolo" name="txtSimbolo" required="required" placeholder="Ingrese Simbolo">
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-lg-6 col-md-12">
                                    <div class="block-area">
                                        <label for="ckLocal">Es la moneda local? </label>
                                        <input type="checkbox" class="form-control m-b-10" id="ckLocal" name="ckLocal">
                                    </div>
                                </div>
                                <div class="col-lg-6 col-md-12">
                                    <div class="block-area">
