<%@ Page Title="" Language="C#" MasterPageFile="~/ASP/master.Master" AutoEventWireup="true" CodeBehind="tipoExistencia_Mantenimiento.aspx.cs" Inherits="wbERPGBL.ASP.tipoExistencia_Mantenimiento" %>
<asp:Content ID="Content1" ContentPlaceHolderID="IDScripts" runat="server">
    <script src="../js/Controllers/jsTipoExistencia.js"></script>
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="IDCuerpo" runat="server">
    <div class="tile">
        <h2 class="tile-title">Mantenimiento de Tipo de Existencia</h2>
                    ...
                    <form id="frmInsertar" action="#">
                        <div class="list-container">
                            <div class="row">
                                <div class="col-lg-6">
                                    <div class="block-area">
                                        <label for="txtTipoExistencia">TIPO EXISTENCIA: </label>
                                        <input type="text" class="form-control m-b-10" id="txtTipoExistencia" name="txtTipoExistencia" placeholder="Ingrese el tipo de existencia..." />
                                    </div>
                                </div>
                                <div class="col-lg-6">
                                    <div class="block-area">
                                        <label for="txtCodigo">Código: </label>
                                        <input type="text" class="form-control m-b-10" id="txtCodigo" name="txtCodigo" placeholder="Ingrese el código..." />
                                    </div>
                                </div>
                            </div>
                        </div>
