<%@ Page Title="" Language="C#" MasterPageFile="~/ASP/master.Master" AutoEventWireup="true" CodeBehind="entidadfinanciera_frmMantenimientoEntidadFinanciera.aspx.cs" Inherits="wbERPGBL.ASP.entidadfinanciera_frmMantenimientoEntidadFinanciera" %>
<asp:Content ID="Content1" ContentPlaceHolderID="IDScripts" runat="server">
    <script src="../js/Controllers/jsEntidadFinanciera.js"></script>
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="IDCuerpo" runat="server">
    <div class="tile">
        <h2 class="tile-title">Mantenimiento de Entidades Financieras</h2>
                            ...
                            <div class="row">
                                <div class="col-lg-12">
                                    <div class="block-area">
                                        ...
                                        <input type="text" class="form-control m-b-10" id="txtEntidad" name="txtEntidad" required="required" placeholder="Ingrese Entidad">
                                    </div>
                                </div>
                            </div>
                            <div class="row">
