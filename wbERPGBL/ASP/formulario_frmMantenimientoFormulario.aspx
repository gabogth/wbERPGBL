<%@ Page Title="" Language="C#" MasterPageFile="~/ASP/master.Master" AutoEventWireup="true" CodeBehind="formulario_frmMantenimientoFormulario.aspx.cs" Inherits="wbERPGBL.ASP.formulario_frmMantenimientoFormulario" %>
<asp:Content ID="Content1" ContentPlaceHolderID="IDScripts" runat="server">
    <script src="../js/Controllers/jsFormulario.js"></script>
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="IDCuerpo" runat="server">
    <div class="tile">
        <h2 class="tile-title">Mantenimiento de Formularios</h2>
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-6 col-md-12">
                                    <div class="block-area">
                                        ...
                                        <select id="cbLink" required="required" name="cbLink" style="width: 100%;">
                                        </select>
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-lg-6 col-md-12">
                                    <div class="block-area">
                                        ...
                                        <select id="cbCategoria" required="required" name="cbCategoria" style="width: 100%;">
                                        </select>
                                    </div>
                                </div>
                                <div class="col-lg-6 col-md-12">
                                    <div class="block-area">
                                        ...
                                        <textarea id="txtDescripcion" name="txtDescripcion" placeholder="Descripción..." class="form-control"></textarea>
                                    </div>
                                </div>
                            </div>
                        </div>
