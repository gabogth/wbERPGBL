<%@ Page Title="" Language="C#" MasterPageFile="~/ASP/master.Master" AutoEventWireup="true" CodeBehind="tipoIntangibleMantenimiento.aspx.cs" Inherits="wbERPGBL.ASP.tipoIntangibleMantenimiento" %>
<asp:Content ID="Content1" ContentPlaceHolderID="IDScripts" runat="server">
    <script src="../js/Controllers/jsTipoIntangible.js"></script>
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="IDCuerpo" runat="server">
    <div class="tile">
        <h2 class="tile-title">Mantenimiento Tipo Intangible</h2>
                    ...
                    <form id="frmInsertar" action="#">
                        <div class="list-container">
                            <div class="row">
                                <div class="col-lg-6">
                                    <div class="block-area">
                                        <label for="txtTipoIntangible">TIPO INTANGIBLE: </label>
                                        <input type="text" class="form-control m-b-10" id="txtTipoIntangible" name="txtTipoIntangible" placeholder="Ingrese el tipo de intangible..." />
                                    </div>
                                </div>
                                <div class="col-lg-6">
                                    <div class="block-area">
